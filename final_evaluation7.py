...
def evaluate_fid(ground_truth_motion_loader, gru_classifier_for_fid, motion_loaders, device, file):
    ...
    for motion_loader_name, motion_loader in motion_loaders.items():
        ...
        # print('gt:', ground_truth_statistics, 'real:', statistics)
...
if __name__ == '__main__':
    ...
    dataset_opt_path = '/homes/55/yansong/action-to-motion/checkpoints/vae/ntu_rgbd_vibe/vanilla_vae_lie_mse_kld01/opt.txt'
    label_spe = None
    eval_motion_loaders = {
    ...
    ground_truth_motion_loader = get_dataset_motion_loader(dataset_opt, num_motions, device, label=3)
    motion_loaders = {}
